...
function pages() {
  return gulp.src('_src/pages/**/*.{html,hbs,handlebars}')
    .pipe(panini({
      root: '_src/pages/',
      layouts: '_src/layouts/',
      partials: '_src/partials/',
      data: '_src/data/',
...
function styleGuide(done) {
  sherpa('_src/styleguide/index.md', {
    output: PATHS.dist + '/styleguide.html',
    template: '_src/styleguide/template.html'
  }, done);
}
...
function sass() {
  return gulp.src('_src/assets/scss/app.scss')
...
function watch() {
  ...
  if ( BROWSERSYNC.type == 'wordpress' ) {
    gulp.watch(['**/*.php', '!{node_modules,.git}/**/*']).on('all', gulp.series(browser.reload));
  }
