...
gulp.task('clean:pot', function() {
	return del(['languages/zf-theme.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		domain: 'zf-theme',
		destFile:'zf-theme.pot',
		package: 'zf-theme',
		bugReport: 'http://zeelandfamily.fi',
		lastTranslator: 'Zeeland Family <daniel.koskinen@zeelandfamily.fi>',
		team: 'Team <daniel.koskinen@zeelandfamily.fi>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "zf-theme.dev",         // Use http://zeelandfamily.fi:3000 to use BrowserSync
		watchOptions: {
